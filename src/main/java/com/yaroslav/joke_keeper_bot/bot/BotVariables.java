...
public class BotVariables {
    ...
    public static final String HELP_TEXT = """
            ...
            Каждый предложенный анекдот рассматривает наша комиссия и за хороший анекдот начисляются монетки
            (Пока функционала с монетками никакого нет, просто циферка на которую можно любоваться)
    ...
    public static final String REQUEST_JOKE = "Пиши шукту ниже и я ее рассмотрю. Если она окажется хорошей, " +
            "то получишь монетку " + "\uD83E\uDD11";
    public static final String GO_BACK = "Передумать";

    public static final String JOKEISGOVNO = "Недостоин " + "❌";
    public static final String START_MESSAGE = "Здарова, если что то не знаешь об этом боте" +
            " или хочешь узнать поподробнее пиши /help";
    public static final List<String> DEFAULT_MESSAGE_LIST = List.of("Ты о чем бро?", "Я тебя не понимаю...",
            "Таким словам меня не учили(",
            "Какой то ты непонятный, чувак", "Мой автор не такой умный, что бы я знал как отвечать");

    public static final List<String> JOKE_GENRES = List.of("Черный юмор", "Сложные", "Пошлые", "Тупые", "Классические",
            "Актуальные");
